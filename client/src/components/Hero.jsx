        ...
        <div className="mx-auto max-w-[1440px] px-4 pt-1 sm:pt-8 flex flex-col justify-between h-full">
          <div className="max-w-3xl">
            <h1 className="h1 !font-[400]    capitalize ">
              Enhance Your
              <span className="!font-[600] text-secondary"> Farm</span> with
              <span className="!font-[600] text-secondary"> Agri</span> Essentials
            </h1>
            <p>
              Experience the future of farming. Shop top-quality agricultural products, trusted brands, and innovative solutions designed to elevate your yields and empower your agribusiness.
            </p>
            <div className="flex">
              <Link to={"/collection"} className="bg-secondary text-white text-xs font-medium capitalize pl-5 rounded-full flexCenter gap-x-2 mt-7 group">
                ...
                <img src={assets.forward} alt="" width={41} className="bg-white rounded-full flexCenter p-2 m-1 group hover:translate-x-1 transition-all duration-500 shadow-lg " />
              </Link>
            </div>
          </div>
          {/*card */}
          <div className="bg-white p-3 max-w-[249px] rounded-2xl mb-4">
            ...
            <p className="text-[13px] pt-2">
              <b className="uppercase">Unlock</b>  your best harvest, one click at a time — your farm upgrade starts here. Shop today!
            </p>
          </div>
        </div>
      </div>
